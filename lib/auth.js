...
async function authenticateUser(identifier, password) {
  try {
    ...
    // Check if user is verified (only for critical operations, not login)
    // Note: Users are auto-verified on registration for better UX
    // Super Admin can manually unverify users if needed
