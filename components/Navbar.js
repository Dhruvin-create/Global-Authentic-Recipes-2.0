...
export default function Navbar() {
    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled
            ? 'bg-white/95 dark:bg-slate-950/95 backdrop-blur-md py-3 shadow-md'
                ...
                <div className="flex justify-between items-center">
                    ...
                    <Link href="/" className="flex items-center gap-2.5 group">
                        <div className="relative">
                            <div className="bg-primary-500 p-2.5 rounded-xl group-hover:bg-primary-600 transition-colors duration-300 shadow-md">
                    ...
                    <div className="hidden lg:flex items-center gap-1">
                        <Link href="/" className="nav-link px-4 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                            Home
                        </Link>
                        <Link href="/recipes" className="nav-link px-4 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                            Recipes
                        </Link>
                        <Link href="/categories" className="nav-link px-4 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                            Cuisines
                        </Link>
                        <Link href="/about" className="nav-link px-4 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                            About
                        </Link>
                    </div>
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        <div className="relative group">
                            <input
                                ...
                                className="w-48 xl:w-64 pl-10 pr-4 py-2 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-full text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all"
                            />
