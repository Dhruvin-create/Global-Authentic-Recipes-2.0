    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pt-20">
      ...
      <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <Link 
            href="/categories"
            className="inline-flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-primary-600 transition-colors mb-4"
          >
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-center">
              <div className="bg-slate-100 dark:bg-slate-800 px-5 py-3 rounded-xl">
                <div className="text-2xl font-bold text-slate-900 dark:text-white">
                  {cuisine.recipe_count || recipes.length}
                </div>
                <div className="text-xs text-slate-600 dark:text-slate-400 font-medium">Recipes</div>
              </div>
              {cuisine.avg_rating && parseFloat(cuisine.avg_rating) > 0 && (
                <div className="bg-slate-100 dark:bg-slate-800 px-5 py-3 rounded-xl">
                  ...
                  <div className="text-xs text-slate-600 dark:text-slate-400 font-medium">Rating</div>
                </div>
              )}
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Filters */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 mb-8 shadow-md border border-slate-200 dark:border-slate-800">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all"
              />
            </div>
            ...
            <select
              ...
              className="px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all font-medium"
            >
        ...
        {/* Results Count */}
        {pagination && (
          <div className="mb-6 text-slate-600 dark:text-slate-400 font-medium">
            Showing <span className="text-primary-600 dark:text-primary-400 font-bold">{recipes.length}</span> of <span className="text-primary-600 dark:text-primary-400 font-bold">{pagination.total}</span> {cuisine.name} recipes
          </div>
        )}
